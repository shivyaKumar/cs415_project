...
class SpacePage extends StatefulWidget {
  ...
  const SpacePage({super.key, required this.programLevels});
...
class _SpacePageState extends State<SpacePage> {
  ...
  Future<void> _loadCourses() async {
    ...
    final spacePrefixes = ['ED', 'UU', 'LN', 'JN'];
    ...
    setState(() {
      ...
      courses = allCourses.values
          .where((course) {
            ...
            return spacePrefixes.contains(prefix) && year == 1 && (sem.contains('Semester 1') || sem.contains('Both'));
          })
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text("Select up to 4 SPACE courses", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
