...
class SafePage extends StatefulWidget {
  ...
  const SafePage({super.key, required this.programLevels});
    ...
    setState(() {
      ...
      courses = allCourses.values
          .where((course) {
            ...
            return safePrefixes.contains(prefix) && year == 1 && (sem.contains('Semester 1') || sem.contains('Both'));
          })
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text("Select up to 4 SAFE courses", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
